...
$
  r/p
$
and can be seen as the sum of the mean of $r$ independent *geometric variables*, $X_i$:
$
...
$
  sigma_Y^2 = r(1 - p)/p^2
$
and, as with the mean, can also be seen as the sum of the variance of $r$ independent geometric variables, $X_i$:
$
...
2. Find the mean ad standard deviation for the number of rolls until the $4^"th"$ success.
$
  mu_Y = E(Y) = 4/(1/6) = 24
$$
