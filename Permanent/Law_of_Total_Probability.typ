...
If you have some set $A$ within some *superset* ${B_n: n = 1, 2, 3, ...}$ (read: a collection of sets) that is *mutually exclusive* and *collectively exhaustive* (read: they wholly encompass the *sample space* without overlap, that is, they *partition* it) then:
$
