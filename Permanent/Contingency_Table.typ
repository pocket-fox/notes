...
Contingency tables are a method of representing *probabilities* and thier composite *sets* visually. They are also called _two way tables_ and _cross tabulation tables_
...
d) $P(M sect B) = 24" (The intersection of the Male column and Business Row)"$\
e) Male or in Business
$
  P(M union B) = (P(M) + P(B) - P(M sect B))/(SS) = ((104) + (36) - (24))/((200))\ "(Sum of Male column and Business row minus the Male and Business cell)"
$
...
$
  ...
  EE/SS = ((24))/((36))\
  "or"\
  P(M|B) = P(M sect B)/P(B) = ((24))/((36))
$
h) Seated in Business given the winner is Male
$
  P(B|M) = P(B sect M)/P(M) = ((24))/((116))
$
